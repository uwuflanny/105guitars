                                ...
                                <h1 class="mb-3">Payment</h1>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="cc-name" name="name" placeholder="John Smith" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="cc-number">Credit card number</label>
                                            <input type="number" class="form-control" id="cc-number" name="number" placeholder="0123456789123456" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="cc-cvv" name="cvv" placeholder="123" required>
                                        </div>
                                    </div>
                                    <hr class="mb-4">
