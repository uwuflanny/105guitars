			...
			<div class="col-lg-10 col-xl-8">
				<div class="card bg-dark" style="border-radius: 10px;">
					<div class="card-header px-4 py-5">
						<h5 class="text-light mb-0">data dell'ordine</h5>
					</div>
					<div class="card-body p-4">
						<div class="d-flex justify-content-between align-items-center mb-4">
							<p class="lead fw-normal mb-0 text-light">Receipt</p>
							<p class="small text-light mb-0">CODICE ORDINE : IOEJFIOWJEFIO</p>
						</div>
						<div class="card shadow-0 border mb-4">
							...
							<div class="card-body">
								<div class="row">
									<div class="col-md-2">
										<img src="https://c.tenor.com/vQAlstk2VfwAAAAj/among-us-among-drip.gif"
											class="img-fluid" alt="Phone">
									</div>
									<div
										class="col-md-2 text-center d-flex justify-content-center align-items-center">
